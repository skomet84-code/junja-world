...
app.get('/api/health',(_req,res)=>res.json({ok:true,game:'JUNJA WORLD',version:'2.9.4',jcoinBridge:'shop-limited',worldAccounts:true,persistence:process.env.DATABASE_URL?'postgres':'sqlite-fallback'}));
